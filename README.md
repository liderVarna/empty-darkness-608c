...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/empty-darkness-608c
```

A live public deployment of this template is available at [https://empty-darkness-608c.templates.workers.dev](https://empty-darkness-608c.templates.workers.dev)
